...
const SearchHeader = () => {
  return (
    <div className="flex justify-between mb-[38px] h-[200px] border-grey-500">
      <div className="flex h-[160px] flex-col">
        <div className="flex justify-between h-[60pxpx] border-b-2 border-grey-500">
          ...
          <div className="flex mt-[10px]">
            <p className="bg-[#296CD6] h-[24px] w-[24px] text-center text-white rounded-[24px] mr-[8px]"> x</p>

            <p className="font-bold text-kandaBlue text-[14px]">Clear search</p>
          </div>
        </div>

        <div className="flex mt-[30px] text-kandaBlack ml-14">
          <div className="mr-[50px] ">
            <p className="text-[#A9AAAA] text-[14px] mb-2">Name</p>
            <p className="font-semibold text-[16px] font-Figtree">Tunde Idiamin</p>
          </div>

          <div>
            <p className="text-[#A9AAAA] text-[14px] mb-2">Asset title no</p>
            <p className="font-semibold text-[16px] font-Figtree">2034-293392HJ</p>
          </div>
        </div>
      </div>
