          ...
          <div className="mt-[40px] flex items-center justify-between h-[88px] md:w-[500px] max-w-[1012px] lg:w-[1012px] bg-[#F9FBFF] rounded-[32px]">
            <div className="flex justify">
              ...
              <div className="ml-4 w-52 pr-4 border-r border-gray-300">
                ...
                <div className="flex text-[#616F82] gap-2 items-center relative">
                  <p>Select market </p>
                  ...
                  {isModalOpen && (
                    <div className="modal absolute font-figtree text-xs font-normal leading-normal w-[316px] h-[128px]">
                      <div className="p-4">
                        <p className="hov py-3 px-2">
                          {" "}
                          <Link to="/financial/search">
                            NGX - Nigerian Exhange Group
                          </Link>
                        </p>
                        <p className="py-3 hov px-2">
                          {" "}
                          <Link to="/financial/search">
            ...
            <Link to="/financial/search">
              <button
                className={`bg-kandaBlue h-[72px] w-[166px] rounded-[28px] mr-2 text-white ${
                  searchInput ? "" : "disabled bg-[#c9cce7]"
                }`}
