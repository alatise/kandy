        ...
        <div className="flex  p-6 w-fit justify-between items-center">
          <div className="flex justify-between items-center">
            <div className="mr-[151px] flex flex-col gap-3 items-start">
              ...
              <h2 className="font-medium">Manage your login pin</h2>
            </div>
          </div>
          <img
          ...
          <div className="flex flex-col gap-8 p-0.5">
            ...
            <div className=" relative">
              ...
              <div className="flex items-center relative">
                ...
                <button
                  type="button"
                  className="ml-2 text-gray-500 focus:outline-none absolute top-1/2 right-2 transform -translate-y-1/2"
