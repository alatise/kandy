...
const AssetTransaction = () => {
  ...
  return (
    <div>
      ...
      <div className="mt-14 flex gap-6 items-start">
        <div className="bg-[#FAFAFA] rounded-[16px] p-6 w-fit flex flex-col gap-7">
        ...
        <div className="flex gap-4 bg-[#FAFAFA] rounded-[12px] w-fit py-[12px] px-[37px]">
        ...
        <div className="flex gap-4 bg-[#296CD6] rounded-[12px] w-fit py-[12px] px-[37px]">
        ...
        <div className="flex p-[18px] border border-[#F0F0F0] rounded-[8px] px-4 py-3 gap-4 items-center bg-[#FAFAFA] justify-center">
          ...
          <div className="cursor-pointer relative">
            ...
            {/* <div className="absolute top-full left-0 bg-black p-3 text-white translate-x-[-50%] translate-y-10 rounded-[12px] modal-arrow">
              ...
              <p className="w-[270px] py-3 text-center rounded-[12px]">
                Agreed offer
              </p>
            </div> */}
          </div>
