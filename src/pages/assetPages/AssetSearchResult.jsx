...
import Grid from "../financial/SearchResultGridView";
      ...
      <div className="w-full">
        ...
        <div className="flex w-full justify-between items-end">
          {selectedRows.length === 0 ? (
            <p className="text-[#121212] mt-4 mb-8 font-figtree text-base font-medium leading-normal">
            ...
            <div className="flex gap-10">
              ...
              <div className="flex">
                <Link to={`/asset/cart`} className="">
                  <button className="flex items-center gap-4 bg-[#296CD6] px-20 py-6 text-[#FFFFFF] rounded-full">
                    Continue{" "}
                    <span>
                      <FaArrowRight />
                    </span>
          ...
          <div className="flex gap-4">
            <div
              className={`flex flex-col gap-1 items-center cursor-pointer ${
                activeView === "grid"
                  ? "text-blue-500 border border-[#296CD6] p-2 rounded-xl"
                  : "text-[#B1B1B1] p-2"
              }`}
